...
for (j in 1:anzahlTage) {
	...
	jpeg(filename = paste(outputFolder, outputPrefix, datensatz0Name, "-", datensatz1Name, "_Linear_", aktuellerTag, "_Regression.jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
	...
	jpeg(filename = paste(outputFolder, outputPrefix, datensatz0Name, "-", datensatz1Name, "_Linear_", aktuellerTag, "_Residuen.jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
