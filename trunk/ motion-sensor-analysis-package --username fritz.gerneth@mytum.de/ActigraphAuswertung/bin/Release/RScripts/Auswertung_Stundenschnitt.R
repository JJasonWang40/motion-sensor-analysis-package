...
jpeg(filename = paste(outputFolder, outputPrefix, datensatz0Name, "_Stundendurchschnitt.jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
