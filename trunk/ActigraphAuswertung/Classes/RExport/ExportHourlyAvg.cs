...
namespace ActigraphAuswertung.RExport
{
    ...
    class ExportHourlyAvg : Abstract
    {
        ...
        public override void checkConditions()
        {
            ...
            {
                throw new RExportException("For hourly average graphs exactly one dataset must be selected");
            }
        }
        ...
        protected override void launchProcess()
        {
            ...
            this.filesInvolved.Add(this.RSettings.FilePrefix + "Auswertung_Stundenschnitt.R");
