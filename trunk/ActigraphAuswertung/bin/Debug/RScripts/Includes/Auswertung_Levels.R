...
for(i in 1:anzahlTage) {
	...
	jpeg(filename = paste("Output/", datensatz0Name, "_LevelAuswertung_",aktuellerTag, ".jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
