...
jpeg(filename = paste("Output/", datensatz0Name, "-", datensatz1Name, "_Kreuzkorrelation.jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
