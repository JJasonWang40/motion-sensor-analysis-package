...
jpeg(filename = paste("Output/", datensatz0Name, "_Schritte_DS_TEST2.jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
