...
for (j in 1:anzahlTage) {
	...
	jpeg(filename = paste(outputFolder, outputPrefix, datensatz0Name, "_TagesAuswertung_",aktuellerTag, ".jpg"), width = outputWidth, height = outputHeight, units = "px", pointsize = 12, quality = 75, bg = "white", restoreConsole = TRUE)
